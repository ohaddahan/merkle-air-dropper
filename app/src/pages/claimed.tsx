...
const Claimed = () => {
    ...
    return (
        <>
            ...
            <FormMain>
                <p>
                    <data value={claimContext.amount}>{claimContext.amount} ${import.meta.env.VITE_TOKEN_NAME}</data>
                    have been sent to
                    <button
                        type="button"
                ...
                <img className={styles.img} src="/merkle-air-drop.png" aria-hidden="true" alt=""/>
                <img className={styles.img} src="/merkle-air-drop.png" aria-hidden="true" alt=""/>
                <img className={styles.img} src="/merkle-air-drop.png" aria-hidden="true" alt=""/>
                <img className={styles.img} src="/merkle-air-drop.png" aria-hidden="true" alt=""/>
            </FormMain>
